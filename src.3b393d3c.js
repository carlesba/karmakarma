...
},{}],"Q40o":[function(require,module,exports) {
'use strict';
...
},{"fbjs/lib/hyphenateStyleName":"R6xY","stylis":"YOxv","stylis-rule-sheet":"UYYs","react":"1n8/","prop-types":"5D9O","hoist-non-react-statics":"89El","react-is":"H1RQ","process":"pBGv"}],"vCxL":[function(require,module,exports) {
"use strict";
...
},{"framesync":"bSZI","style-value-types":"Hokg","tslib":"vCxL","hey-listen":"KFGT"}],"z2lI":[function(require,module,exports) {
'use strict';
...
},{"tslib":"vCxL","framesync":"bSZI","style-value-types":"Hokg","hey-listen":"KFGT","stylefire":"Q4bC"}],"QhN+":[function(require,module,exports) {
'use strict';

Object.defineProperty(exports, "__esModule", {
    value: true
});
exports.fromPose = exports.eachValue = undefined;
...
var getPoseValues = function (_a) {
    var transition = _a.transition,
        ...
        props = (0, _tslib.__rest)(_a, ["transition", "delay", "delayChildren", "staggerChildren", "staggerDirection", "afterChildren", "beforeChildren", "preTransition"]);
    return props;
};
...
var startChildAnimations = function (children, next, pose, props) {
    ...
    Array.from(children).forEach(function (child, i) {
        animations.push(child.set(next, (0, _tslib.__assign)({}, props, { delay: delay + generateStaggerDuration(i) })));
    });
    return animations;
};
        ...
        var getParentAnimations = function () {
            ...
            return Object.keys(getPoseValues(nextPose)).map(function (key) {
                return new Promise(function (complete) {
                    ...
                    var transitionProps = (0, _tslib.__assign)({}, baseTransitionProps, { key: key,
                        value: value });
                    var target = resolveTarget(value, resolveProp(nextPose[key], transitionProps));
                    if (activeActions.has(key)) stopAction(activeActions.get(key));
                    var resolveTransitionProps = (0, _tslib.__assign)({ to: target }, transitionProps, getTransitionProps(value, target, transitionProps));
...
var applyDefaultTransition = function (pose, key, defaultTransitions) {
    return (0, _tslib.__assign)({}, pose, { transition: defaultTransitions.has(key) ? defaultTransitions.get(key) : defaultTransitions.get('default') });
};
...
var poseFactory = function (_a) {
    ...
    return function (config) {
        ...
        if (getDefaultProps) props = (0, _tslib.__assign)({}, props, getDefaultProps(config));
        ...
        var api = {
            ...
            _addChild: function (childConfig, factory) {
                var child = factory((0, _tslib.__assign)({ initialPose: initialPose }, childConfig, { ancestorValues: [{ label: config.label, values: values }].concat(ancestorValues) }));
                children.add(child);
                return child;
            },
...
var _poseCore = require('pose-core');

var _poseCore2 = _interopRequireDefault(_poseCore);
...
var linear = _popmotion.easing.linear;
...
var overDampedSpring = function (_a) {
    var from = _a.from,
        velocity = _a.velocity,
        to = _a.to;
    return (0, _popmotion.spring)({ from: from, to: to, velocity: velocity, stiffness: 700, damping: to === 0 ? 100 : 35 });
};
var linearTween = function (_a) {
    var from = _a.from,
        to = _a.to;
    return (0, _popmotion.tween)({ from: from, to: to, ease: linear });
};
...
var createPassiveValue = function (init, parent, transform$$1) {
    var raw = (0, _popmotion.value)(init).pipe(transform$$1);
...
var linear$1 = _popmotion.easing.linear,
    easeIn = _popmotion.easing.easeIn,
    easeOut = _popmotion.easing.easeOut,
    easeInOut = _popmotion.easing.easeInOut,
    circIn = _popmotion.easing.circIn,
    circOut = _popmotion.easing.circOut,
    circInOut = _popmotion.easing.circInOut,
    backIn = _popmotion.easing.backIn,
    backOut = _popmotion.easing.backOut,
    backInOut = _popmotion.easing.backInOut,
    anticipate = _popmotion.easing.anticipate;
var easingLookup = {
    linear: linear$1,
    easeIn: easeIn,
    easeOut: easeOut,
    ...
    if (type === 'tween') {
        ...
        if (typeOfEase !== 'function') {
            if (typeOfEase === 'string') {
                (0, _heyListen.invariant)(easingLookup[ease] !== undefined, "Invalid easing type '" + ease + "'. popmotion.io/pose/api/config");
                ease = easingLookup[ease];
            } else if (Array.isArray(ease)) {
                (0, _heyListen.invariant)(ease.length === 4, "Cubic bezier arrays must contain four numerical values.");
                var x1 = ease[0],
                    y1 = ease[1],
                    x2 = ease[2],
                    y2 = ease[3];
                ease = _popmotion.easing.cubicBezier(x1, y1, x2, y2);
            }
        }
    }
...
var makeDraggable = function (element, activeActions, setPose, _a) {
    ...
    var dragStartListener = (0, _popmotion.listen)(element, 'mousedown touchstart').start(function (startEvent) {
        startEvent.preventDefault();
        setPose('dragging');
        if (onDragStart) onDragStart(startEvent);
        var dragEndListener = (0, _popmotion.listen)(document, 'mouseup touchend').start(function (endEvent) {
...
var createPoseConfig = function (element, _a) {
    ...
    var poseConfig = __assign({ flip: {} }, config, { props: __assign({}, config.props, { draggable: draggable,
            ...
            element: element, elementStyler: (0, _popmotion.styler)(element, { preparseOutput: false }), dimensions: createDimensions(element) }) });
    if (draggable) {
...
},{"popmotion":"z2lI","style-value-types":"Hokg","pose-core":"QhN+","hey-listen":"KFGT"}],"mfSv":[function(require,module,exports) {
'use strict';

Object.defineProperty(exports, "__esModule", {
    value: true
});
exports.PoseGroup = undefined;
...
var PoseParentContext = (0, _react.createContext)({});
...
var PoseElement = function (_super) {
    ...
    PoseElement.prototype.getSetProps = function () {
        var _a = this.props,
            ...
            onDragEnd = _a.onDragEnd,
            props = (0, _tslib.__rest)(_a, ["children", "elementType", "poseConfig", "onValueChange", "innerRef", "_pose", "pose", "initialPose", "poseKey", "onPoseComplete", "getParentPoseConfig", "registerChild", "onUnmount", "getInitialPoseFromParent", "popFromFlow", "values", "parentValues", "onDragStart", "onDragEnd"]);
    ...
    PoseElement.prototype.componentDidMount = function () {
        ...
        var _a = this.props,
            ...
            onDragStart = _a.onDragStart,
            onDragEnd = _a.onDragEnd;
        var config = (0, _tslib.__assign)({}, poseConfig, { initialPose: this.getInitialPose(), values: values || poseConfig.values, parentValues: parentValues ? objectToMap(parentValues) : undefined, props: this.getSetProps(), onDragStart: onDragStart,
            onDragEnd: onDragEnd, onChange: onValueChange });
        if (!registerChild) {
            this.initPoser((0, _popmotionPose2.default)(this.ref, config));
        } else {
            registerChild({
                element: this.ref,
                poseConfig: config,
    ...
    PoseElement.prototype.componentDidUpdate = function (prevProps) {
        ...
        if (poseKey !== prevProps.key || hasChanged(prevProps.pose, pose) || pose === 'flip') {
            this.setPose(pose);
        }
    ...
    PoseElement.prototype.render = function () {
        var _a = this.props,
            elementType = _a.elementType,
            children = _a.children;
        return (0, _react.createElement)(PoseParentContext.Provider, { value: this.childrenHandlers }, (0, _react.createElement)(elementType, (0, _tslib.__assign)({}, this.getSetProps(), this.getRefs()), children));
    };
    return PoseElement;
...
var createComponentFactory = function (key) {
    var componentFactory = function (poseConfig) {
        ...
        return function (_a) {
            ...
            return !withParent || props.parentValues ? (0, _react.createElement)(PoseElement, (0, _tslib.__assign)({ poseConfig: poseConfig, elementType: key }, props)) : (0, _react.createElement)(PoseParentContext.Consumer, null, function (parentCtx) {
                return (0, _react.createElement)(PoseElement, (0, _tslib.__assign)({ poseConfig: poseConfig, elementType: key }, props, parentCtx));
            });
        };
    };
...
var Children$1 = _react.Children,
    cloneElement$1 = _react.cloneElement;
...
var Fragment$1 = _react.Fragment;
var PoseGroup = function (_super) {
    ...
    PoseGroup.prototype.render = function () {
        var children = this.state.children;
        return (0, _react.createElement)(Fragment$1, null, children);
    };
...
},{"tslib":"vCxL","react":"1n8/","popmotion-pose":"nnUu","hey-listen":"KFGT"}],"FSwq":[function(require,module,exports) {
'use strict';
...
var Display = _reactPose2.default.div({
  current: { top: 0, opacity: 1 },
  above: { top: '30vh', opacity: 0 },
  bellow: { top: '-30vh', opacity: 0 }
});

var StyledDisplay = (0, _styledComponents2.default)(Display)(_templateObject);
StyledDisplay.displayName = 'Display';

var DisplayCount = function DisplayCount(_ref) {
  var count = _ref.count,
      position = _ref.position;
  return _react2.default.createElement(
    StyledDisplay,
    { pose: position, className: position },
    parseCount(count)
  );
};

var parsePositives = function parsePositives(number) {
  return '+' + number;
};

var parseCount = function parseCount(number) {
  return number > 0 ? parsePositives(number) : number === 0 ? ' ' + number : number;
};
...
exports.default = function (_ref2) {
  ...
  return _react2.default.createElement(
    ...
    null,
    _react2.default.createElement(DisplayCount, { key: count + 1, position: 'bellow', count: count + 1 }),
    _react2.default.createElement(DisplayCount, { key: count, position: 'current', count: count }),
    _react2.default.createElement(DisplayCount, { key: count - 1, position: 'above', count: count - 1 })
  );
};
},{"react":"1n8/","styled-components":"tFSs","react-pose":"mfSv"}],"eBcb":[function(require,module,exports) {
'use strict';
...
var _CountDisplay = require('./CountDisplay');
...
var App = function (_Component) {
  ...
  function App(props) {
    ...
    _this.commit = function (karma) {
      return _this.setState({ karma: karma }, function () {
        localStorage.setItem('karma', karma);
      });
    };

    var savedKarma = Number(localStorage.getItem('karma'));
    _this.state = {
      karma: savedKarma || 0
    };
    return _this;
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(Button, {
          onClick: function onClick() {
            return _this2.commit(_this2.state.karma + 1);
          },
          color: '#333'
        }),
        _react2.default.createElement(
          CountWrapper,
          null,
          _react2.default.createElement(_CountDisplay2.default, { count: this.state.karma })
        ),
        _react2.default.createElement(Button, {
          reverse: true,
          onClick: function onClick() {
...
var Button = _styledComponents2.default.div(_templateObject3, function (p) {
  return p.reverse ? 'rotate(180deg)' : '';
}, function (p) {
  return p.color;
});
var CountWrapper = _styledComponents2.default.div(_templateObject4);

exports.default = App;
},{"react":"1n8/","./CountDisplay":"FSwq","styled-components":"tFSs"}],"Yw6x":[function(require,module,exports) {
'use strict';
...
//# sourceMappingURL=/karmakarma/src.b9e9ffb0.map